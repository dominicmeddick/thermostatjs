...
describe('Thermostat', () => {
  ...
  it('is low usage', () => {
    ...
    expect(thermostat.currentConsumption()).toEqual('low-usage')
  })
  ...
  it('is medium usage', () => {
    ...
    expect(thermostat.currentConsumption()).toEqual('medium-usage')
  })
  ...
  it('is high usage', () => {
    ...
    expect(thermostat.currentConsumption()).toEqual('high-usage')
  })
});